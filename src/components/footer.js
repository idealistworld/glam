export default function Footer() {
    return (
        <footer class="inset-x-0 bottom-0 rounded-lg shadow m-4 bg-[#F7F9FC]">
            <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Glam App</a>. All Rights Reserved.
                </span>
