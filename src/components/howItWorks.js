  ...
  return (
    <div className='flex-wrap relative bg-cover px-5 flex items-center justify-around w-[100%'>
      ...
      <div className='max-md:mt-6 box-border max-md:w-[95%] max-lg:px-5 max-lg:py-3 py-8 px-8 rounded-3xl w-[40%] mb-8 max-md:mb-0 line-shadow animated-gradient hover:scale-105 duration-300'>
        <h1 className='max-lg:text-3xl max-lg:mt-0 text-3xl font-semibold bg-clip-text  text-neutral-600'>1. Upload content</h1>
      ...
      <div className='max-md:mt-6 box-border max-md:w-[95%] max-lg:px-5 max-lg:py-3 py-8 px-8 rounded-3xl w-[40%] mb-8 max-md:mb-0 line-shadow animated-gradient hover:scale-105 duration-300'>
      <h1 className='max-lg:text-3xl max-lg:mt-0 text-3xl font-semibold bg-clip-text  text-neutral-600'>2. Pick an effect</h1>
      ...
      <div className='max-md:mt-6 box-border max-md:w-[95%] max-lg:px-5 max-lg:py-3 py-8 px-8 rounded-3xl w-[40%] mb-8 max-md:mb-0 line-shadow animated-gradient hover:scale-105 duration-300'>
      <h1 className='max-lg:text-3xl max-lg:mt-0 text-3xl font-semibold bg-clip-text  text-neutral-600'>3. Share the result</h1>
