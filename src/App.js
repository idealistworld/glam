      ...
      <body id='product' class ='py-14 flex-col items-center justify-center '>
        <div class='flex flex-wrap-reverse px-7 py-20 justify-center items-center bg-landing bg-cover'>
          <div class ='max-lg:w-[100%] max-lg:mt-14 w-[40%] mr-[80px] max-lg:mr-[0px] z-30'>
            ...
            <div class = 'max-sm:flex-col flex mt-12'>
              ...
              <img src={googlePlay} class ='max-sm:ml-0 max-sm:mt-10 max-lg:h-14 ml-6 transform drop-shadow-2xl h-14 hover:scale-110 duration-300 hover:rotate-6'></img>          
              </a>
            </div>
          </div>
        ...
        <div class='py-10 px-5 my-8 bg-white flex flex-wrap items-center justify-around max-md:py-7 max-lg:justify-start'>
