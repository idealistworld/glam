...
function App() {
  return (
    <div>
      <header  class ='fixed z-50 w-screen box-border backdrop-blur-3xl drop-shadow-2xl bg-white/50 px-8 py-4 max-lg:px-3 flex justify-between items-center'>
        <img class='h-10 max-lg:h-6' src ={glamLogo}></img>
